...
4 - Gauss Seidel'''),
    ...
    ('pf_max_it', 30, 'maximum number of iterations for Newton\'s method'),

    ('pf_max_it_fd', 50, 'maximum number of iterations for fast '
     'decoupled method'),
    ...
    ('pf_dc', True, '''use DC power flow formulation, for power flow and OPF:
